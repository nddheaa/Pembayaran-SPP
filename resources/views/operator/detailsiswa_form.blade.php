            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="siswa_id">ID Siswa (Optional)</label>
                        {!! Form::select('siswa_id', $detailsiswa, null, ['class' => 'form-control select2', 
                        'placeholder'=>'Pilih ID Siswa']) !!}
                        <span class="text-danger">{{ $errors->first('siswa') }}</span>
                    </div>
                    <div class="form-group">
